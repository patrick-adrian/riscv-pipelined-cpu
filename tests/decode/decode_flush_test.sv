...
class decode_flush_test extends decode_base_test;
    ...
    virtual task run();
        // TXN 0: reset (start from known zero state)
        decode_txn t = new();
        t.reset              = 1'b1;
        t.stall              = 1'b0;
        t.flush              = 1'b0;
        ...
        // TXN 2: flush while stalled (flush must win)
        t = new();
        t.reset              = 1'b0;
        t.stall              = 1'b1;
        t.flush              = 1'b1;
        t.pc_src_pred_fi     = 1'b0;
        t.instr_fi_i         = 32'h1111_2222;
        ...
        // TXN 3: capture after flush
        t = new();
        t.reset              = 1'b0;
        t.stall              = 1'b0;
        t.flush              = 1'b0;
        t.pc_src_pred_fi     = 1'b1;
        t.instr_fi_i         = 32'hCAFEBABE;
