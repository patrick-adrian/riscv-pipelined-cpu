...
// is still combinational; clk/reset/tb_valid only define the sampled cycle
// semantics used by the driver, monitor, and scoreboard.
interface control_if(input logic clk);
    ...
    assign op_de     = instr_de[6:0];
    assign funct3_de = instr_de[14:12];
    assign funct7_de = instr_de[31:25];
